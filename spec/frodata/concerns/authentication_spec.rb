...
describe FrOData::Concerns::Authentication do
  let(:klass) do
    context = self
    Class.new {
  ...
  describe '.authenticate!' do
    ...
    context 'when there is no authentication middleware' do
      ...
      it "raises an error" do
        expect { authenticate! }.to raise_error FrOData::AuthenticationError,
  ...
  describe '.authentication_middleware' do
    ...
    it { should eq FrOData::Middleware::Authentication::Token }
    end
  end
