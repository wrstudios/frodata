...
describe OData::EntitySet, vcr: {cassette_name: 'v4/entity_set_specs'} do
  before(:example) do
  ...
  describe '#<<' do
    ...
    xdescribe 'with an existing entity', vcr: {cassette_name: 'v4/entity_set_specs/existing_entry'} do
      before(:each) do
    ...
    xdescribe 'with a new entity', vcr: {cassette_name: 'v4/entity_set_specs/new_entry'} do
      it do
    ...
    describe 'with a bad entity', vcr: {cassette_name: 'v4/entity_set_specs/bad_entry'} do
